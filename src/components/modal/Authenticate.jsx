  ...
  const handleSubmit = () => {
    if (method === "login") {
      ...
      if (data.success) {
        ...
        handleClose();
        dispatch({ type: "setSnackData", payload: { open: true, text: "Successfully Loggedin Welcome to PetHeaven" } })
      } else {
        dispatch({ type: "setSnackData", payload: { open: true, text: "Invalid Credentials . Try Again !" } })
      }
    } else {
      ...
      if (data.success) {
        ...
        handleClose();
        dispatch({ type: "setSnackData", payload: { open: true, text: "Successfully Registered Welcome to PetHeaven" } })
      } else {
